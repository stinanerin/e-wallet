...
export const FormInput = (props) => {
    ...
    return (
      ...
      uppercase border-0 rounded-md bg-elem_bg py-1 px-2 w-full text-text-default text-sm shadow-md  disabled:opacity-50 focus:outline-none focus:ring focus:ring-primary-600`}
                {...inputProps}
